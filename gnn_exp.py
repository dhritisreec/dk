...
def ensure_directory_exists(directory):
    ...
    filename = f"result_{timestamp}_"
    filename += "_".join([f"{key}={value}" for key, value in args.items()])
    return filename
    pass
...
RESULTS_DIR = 'results'  # Relative path to store experiment results
...
if __name__ == '__main__':
    ...
    results = results_sgc + results_mlp'''
